...
cl /Febassmididrv.dll /O1 /MT /EHsc /D_WIN32_WINNT=0x0501 /D_USING_V110_SDK71_ /DUNICODE /D_UNICODE /LD /I "..\external_packages" /MP%NUMBER_OF_PROCESSORS% MidiSynth.cpp winmm_drv.cpp kernel32.lib user32.lib Shlwapi.lib advapi32.lib winmm.lib Ole32.lib uuid.lib %INCLUDEBASS% bassmididrv.def
